...
body{padding-top:30px;  background-image: url(); background-size: 100%;
...
<div class="col-sm-6 col-md-4 col-lg-3 ">
        <div class="thumbnail">
         <div class="caption">
         <h2></h2><br>
          <h3><a href="lucky_on?round=1">开启第一轮红包雨</a></h3>
...
<div class="col-sm-6 col-md-4 col-lg-3 ">
        ...
        <div class="caption">
        <h2></h2><br>
        <h3><a href="lucky_on?round=2">开启第二轮红包雨</a></h3> 
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 ">
        ...
        <div class="caption">
        <h2></h2><br>
         <h3><a href="lucky_on?round=3">开启第三轮红包雨</a></h3>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 ">
        ...
        <div class="caption">
        <h2></h2><br>
         <h3><a href="viewrecord">查看红包的记录</a></h3>
